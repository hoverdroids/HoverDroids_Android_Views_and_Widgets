...
/**
 * TwoWayGridView that can handle a ViewModel and synchronizes touch events with other AdapterViews
 ...
 */
public class TouchSyncTwoWayGridView extends com.hoverdroids.adapterview.view.TouchSyncTwoWayGridView implements ModelView {

    private ViewModel viewModel;

    protected ViewModelAdapter adapter;

    public TouchSyncTwoWayGridView(final @NonNull Context context) {
        super(context);
        init();
        initViews();
    }

    public TouchSyncTwoWayGridView(final @NonNull Context context, final @Nullable AttributeSet attrs) {
        super(context, attrs);
        init();
    }

    public TouchSyncTwoWayGridView(final @NonNull Context context, final @Nullable AttributeSet attrs, final int defStyleAttr) {
    ...
    public void setViewModel(final ViewModel viewModel) {
        ...
        if (viewModel instanceof TouchSyncModel) {
            setOnSourceTouchEventListener((TouchSyncModel) viewModel);
        }
    ...
    /**
     * Set the onSourceTouchEventListener.
     * @param model The model
     */
    private void setOnSourceTouchEventListener(final TouchSyncModel model) {
        if (model.getOnSourceTouchEventListener() != null) {
            setOnSourceTouchEventListener(model.getOnSourceTouchEventListener());
        }
    }
