...
package com.hoverdroids.adapterviews;
...
public abstract class AdapterView<T extends Adapter> extends ViewGroup {
    ...
    class AdapterDataSetObserver extends DataSetObserver
    {
        ...
        public void onChanged() {
            ...
            if (com.hoverdroids.adapterviews.AdapterView.this.getAdapter().hasStableIds() && mInstanceState != null
                    && mOldItemCount == 0 && mItemCount > 0) {
                com.hoverdroids.adapterviews.AdapterView.this.onRestoreInstanceState(mInstanceState);
                mInstanceState = null;
            } else {
                rememberSyncState();
            }
        ...
        public void onInvalidated() {
            ...
            if (com.hoverdroids.adapterviews.AdapterView.this.getAdapter().hasStableIds()) {
                // Remember the current state for the case where our hosting activity is being
                // stopped and later restarted
                mInstanceState = com.hoverdroids.adapterviews.AdapterView.this.onSaveInstanceState();
            }
